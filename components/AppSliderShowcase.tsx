...
function SlideScene({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex-1 rounded-2xl md:rounded-3xl bg-[#0a0c12] border border-white/[0.12] shadow-[0_30px_90px_rgba(0,0,0,0.9)] overflow-hidden flex flex-col">
        
        {/* Window Chrome */}
        <div className="h-10 px-5 bg-black/60 border-b border-white/[0.08] flex items-center justify-between shrink-0 backdrop-blur-md">
          ...
          <div className="w-12 text-right text-[11px] font-mono text-slate-500">
            0{index + 1} / 04
          </div>
        </div>
